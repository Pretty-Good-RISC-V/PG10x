...
#
# pg100-arty-a7-100.tcl: Tcl script for re-creating project 'pg100-artya7'
#
...
#
# 1. This project restoration tcl script (pg100-arty-a7-100.tcl) that was generated.
#
...
set _xil_proj_name_ "pg100-artya7"
...
set script_file "pg100-arty-a7-100.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../pg100-artya7"]"
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/pg100-artya7.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/pg100-artya7.srcs/utils_1/imports/impl_1" -objects $obj
